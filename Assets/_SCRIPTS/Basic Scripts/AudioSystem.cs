...
public class AudioSystem : ObjectSingleton<AudioSystem>
{
#pragma warning disable CS0649
    ...
    [Space]
    [SerializeField] private Vector2 _randomVolumeRange = new Vector2(0.8f, 1f);
    [SerializeField] private Vector2 _randomPitchRange = new Vector2(0.8f, 1f);
#pragma warning restore CS0649


    public void SetMusicSource(AudioSource MAS) => _musicSource = MAS;
    public void SetVoiceSource(AudioSource VAS) => _voiceoverSource = VAS;
    public void SetSfxSource(AudioSource SAS) => _sfxSource = SAS;
    public void SetUISource(AudioSource UAS) => _uiSource = UAS;
